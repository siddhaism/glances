...
class glancesScreen:
    ...
    def displayProcessSumary(self, process, line, pad,
        ...
        pad.addnstr(
            line, 0,
            format(self.__autoUnit(process_size, low_precision=True), '>5'), 5)
        # RSS
        process_resident = process['memory_info'][0]
        pad.addnstr(
            line, 6,
            format(self.__autoUnit(process_resident, low_precision=True), '>5'), 5)
        # CPU%
        ...
        if tag_io:
            if not process_tag_io:
                ...
                pad.addnstr(
                    line, 56,
                    format(self.__autoUnit(io_rs, low_precision=True), '>5'), 5)
                pad.addnstr(
                    line, 62,
                    format(self.__autoUnit(io_ws, low_precision=True), '>5'), 5)
